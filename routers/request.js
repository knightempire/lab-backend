...
const { addRequest, updateRequest, fetchRequest, fetchAllRequests, approveRequest, rejectRequest, 
    fetchUserRequests, fetchRefRequests, fetchRequestByStatus, getUserRequests, getUserRequestsOptimal, collectProducts, 
...
request.get('/user/optimal/:pageno', getUserRequestsOptimal);

...
const { updateUser, fetchUser, userStats, getRequestsandDamagedCounts } = require('../controllers/profile.controllers');
...
users.get('/requests-and-damaged-counts', tokenValidator, getRequestsandDamagedCounts);
